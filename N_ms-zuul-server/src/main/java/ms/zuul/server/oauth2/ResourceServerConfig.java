...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter{
	...
	public JwtAccessTokenConverter accessTokenConverter() {
		...
		tokenConverter.setSigningKey(Base64.getEncoder().encodeToString(jwtKey.getBytes()));													//2 - levantando spring cloud config, lee la propiedad desde el application properties q está en github.
